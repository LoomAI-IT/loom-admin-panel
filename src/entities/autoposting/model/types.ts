...
import type {AutopostingFormData} from "../lib/transformers";

export const autopostingFormSections: FormSection<AutopostingFormData>[] = [
    {
        ...
        fields: [
            {
                name: 'name',
                type: 'input',
                label: 'Название рубрики автопостинга',
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                placeholder: 'Описание фильтрации контента...',
                required: true,
                debounceDelay: 500,
            },
            {
...
export const autopostingDetailsSections: DetailSection<AutopostingFormData>[] = [
    {
        title: 'Основная информация',
        fields: [
            {
