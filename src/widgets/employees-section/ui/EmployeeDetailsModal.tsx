            ...
            <div className="employee-details">
                ...
                <div className="employee-details-section">
                    ...
                    <div className="employee-permissions">
                        ...
                        <div
                            className={`permission-badge ${employee.edit_employee_perm_permission ? 'active' : 'inactive'}`}>
                            <span
                                className="permission-icon">{employee.edit_employee_perm_permission ? '✓' : '✕'}</span>
                            Редактирование прав
                        </div>
                        <div
                            className={`permission-badge ${employee.top_up_balance_permission ? 'active' : 'inactive'}`}>
                            <span className="permission-icon">{employee.top_up_balance_permission ? '✓' : '✕'}</span>
                            Пополнение баланса
                        </div>
                        <div
                            className={`permission-badge ${employee.sign_up_social_net_permission ? 'active' : 'inactive'}`}>
                            <span
                                className="permission-icon">{employee.sign_up_social_net_permission ? '✓' : '✕'}</span>
